...
#'
#' @param kappa value for contact scaling constant (influences slope of density-contact relationship; reported in Habib et al. 2011)
...
#' @param who_attractant proportional change for attractants present in simulated conditions (optional). Default set to 1
...
#' @param type_contact option between "low", "medium", and "high" based on parameters from Habib et al. 2011 for particular values of wooded habitat available to the deer population in question. "low" contact fixes kappa to 16.37 and q to 0.53, mimicking proximity rates in areas with 53% wooded habitat. "med" contact fixes kappa to 11.35 and q to 0.34, mimicking proximity rates in areas with 26% wooded habitat. "high" contact fixes kappa to 15.58 and q to 0.32, mimicking proximity rates in areas with 12% wooded habitat. If set to "manual", manual input of kappa and q are needed. All values from Habib et al. (2011) are available in the `contact_rate_params` dataset.
#'
