...
#' @param omega_ww Deer-deer proximity rate in a wild setting (proximity events per day).
#' @param omega_cw Captive and wild deer proximity rate along fence lines demarking captive and wild populations (proximity events per day).
#' @param omega_cc Deer-deer proximity rate in a captive setting (proximity events per day).
#' @param omega_hw Human-deer proximity rate in a wild setting (proximity events per day).
#' @param omega_hc Human-deer proximity rate in a captive setting(proximity events per day).
#' @param sigma_aero_deer_deer_wild Probability of infection via aerosol transmission between wild deer. Derived using the calc_sigma_aero() function.
#' @param sigma_aero_deer_deer_captive Probability of infection via aerosol transmission in captive deer. Derived using the calc_sigma_aero() function.
#' @param sigma_aero_deer_human_wild Probability of infection via aerosol transmission from humans to wild deer. Derived using the calc_sigma_aero() function.
#' @param sigma_aero_deer_human_capt Probability of infection via aerosol transmission from humans to captive deer. Derived using the calc_sigma_aero() function.
#' @param epsilon_dc Probability of direct contact between deer, given proximity.
#' @param sigma_dc_deer_deer Probability of infection via fluid transmission between deer. Derived using the calc_sigma_dc() function.
