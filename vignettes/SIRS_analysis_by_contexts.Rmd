...
df %>% 
  ...
  reframe(., R0.Median = round(quantile(r0,probs = c(0.5)),2), 
          ...
          FOI.Median = round(log10(quantile(FOI*100,probs = c(0.5))),2), 
          FOI.80CI = paste0(round(log10(quantile(FOI*100,probs = c(0.1))),2)," - ",round(log10(quantile(FOI*100,probs = c(0.9))),2)), 
