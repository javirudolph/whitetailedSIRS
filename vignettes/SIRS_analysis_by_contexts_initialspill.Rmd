...
```{r Compiler 1:1000, warning=FALSE, message=FALSE, results='hide'}
...
```{r Compiler 1:1 mil, warning=FALSE, message=FALSE, results='hide'}
...
```{r Compiler 1:1 bil, warning=FALSE, message=FALSE, results='hide'}
